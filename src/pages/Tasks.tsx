    ...
    return (
      <div className="p-6 flex flex-col items-center justify-center min-h-[600px] text-center">
        ...
        <p className="text-slate-500 dark:text-slate-400 max-w-md mb-4 leading-relaxed">
          Você precisa da permissão <code className="bg-slate-100 dark:bg-slate-800/50 px-2 py-1 rounded-lg text-sm font-mono text-slate-700 dark:text-slate-300">tasks.view</code> para acessar as tarefas.
        </p>
