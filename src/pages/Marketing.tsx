    ...
    return (
      <div className="p-6 flex flex-col items-center justify-center min-h-[600px] text-center">
        ...
        <p className="text-slate-500 dark:text-slate-400 max-w-md mb-4 leading-relaxed">
          Você precisa da permissão <code className="bg-slate-100 dark:bg-slate-800/50 px-2 py-1 rounded-lg text-sm font-mono text-slate-700 dark:text-slate-300">marketing.view</code> para acessar o marketing.
        </p>
  ...
  return (
    <div className="p-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-200">Marketing</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">Campanhas, automações e métricas de marketing.</p>
        </div>
