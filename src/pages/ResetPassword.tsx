      ...
      >
        <div className="p-8 md:p-12">
          <div className="flex flex-col items-center mb-10">
            ...
            <h1 className="text-3xl font-bold text-slate-800 dark:text-slate-200 text-center">Nova Senha</h1>
            <p className="text-slate-500 dark:text-slate-400 mt-2 font-medium text-center">Defina sua nova senha de acesso</p>
          </div>
          ...
          {success ? (
            ...
            <form onSubmit={handleReset} className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider ml-1">Confirmar Senha</label>
                <div className="relative">
                  <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400" size={18} />
                  <input 
                    required
