  ...
  if (totalCount === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-slate-400">
        ...
        <p className="text-xs mt-1 text-slate-300">Configure em Configurações → Checklists</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Checklist da Etapa</p>
          <p className="text-xs text-slate-400 mt-0.5">Marque os itens concluídos para avançar de etapa</p>
        </div>
        <div className={cn(
          ...
          {allRequiredCompleted ? <CheckSquare size={13} /> : <AlertCircle size={13} />}
