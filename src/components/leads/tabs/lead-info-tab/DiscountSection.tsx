      ...
      <label className="flex items-center gap-3 cursor-pointer w-fit">
        <div className="relative">
          ...
          <div className={cn(
            ...
            formData.discount_applied ? "bg-emerald-600 border-emerald-600" : "bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700"
          )}>
            {formData.discount_applied && <CheckSquare size={12} className="text-white" />}
          </div>
        </div>
        <span className="text-sm font-bold text-slate-700 dark:text-slate-300">Aplicar desconto?</span>
      </label>
      ...
      <div className={cn(
        ...
        <div className="flex rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 shrink-0">
          <button
            ...
            className={cn(
              ...
              formData.discount_type === 'percent'
                ...
                : "bg-white dark:bg-slate-900 text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:bg-slate-800"
            )}
          >
            <Percent size={12} /> %
          </button>
          <button
            ...
            className={cn(
              "px-3 py-2.5 text-xs font-bold transition-colors border-l border-slate-200 dark:border-slate-700 flex items-center gap-1",
        ...
        <input
          ...
          className="flex-1 px-4 py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all font-medium shadow-sm"
        />
      </div>
    </div>
  );
