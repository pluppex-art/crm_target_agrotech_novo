...
export const supabaseService = {
  async getLeads(pipelineId?: string, startDate?: string, endDate?: string): Promise<Lead[]> {
    ...
    return data.map((lead: any) => {
      ...
      return {
        ...
        valor_recebido_paid_at: activeEnrollment?.valor_recebido_paid_at ?? lead.valor_recebido_paid_at ?? null,
        taxa_matricula_recebido: activeEnrollment?.taxa_matricula_recebido ?? lead.taxa_matricula_recebido ?? null,
        taxa_matricula_paid_at: activeEnrollment?.taxa_matricula_paid_at ?? lead.taxa_matricula_paid_at ?? null,
  ...
  async createLead(lead: Omit<Lead, 'id'>): Promise<Lead | null> {
    ...
    const {
      ...
      valor_recebido, valor_recebido_paid_at, taxa_matricula_recebido, forma_pagamento,
