  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      const updateData: Partial<Lead> = {
        ...
        valor_recebido: formData.valor_recebido != null ? parseBRNumber(formData.valor_recebido) : undefined,
        forma_pagamento: formData.forma_pagamento || undefined,
        taxa_matricula_recebido: formData.taxa_matricula_recebido != null ? parseBRNumber(formData.taxa_matricula_recebido) : undefined,
